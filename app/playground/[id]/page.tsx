...
const MainPlaygroundPage = () => {
    ...
    const activeFile = openFiles.find((file) => {
        console.log("checking file ", file, activeFileId);
    ...
    const handleSave = useCallback(async (fileId?: string) => {
        ...
        if (!fileToSave) return //given fileId is not opened so simply return (no need of saving)
        ...
        try {
            ...
            const updatedTemplateData = JSON.parse(JSON.stringify(latestTemplateData)); // deep copy
            // @ts-ignore
