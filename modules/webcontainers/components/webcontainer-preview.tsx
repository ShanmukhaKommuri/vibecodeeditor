...
import { type TemplateItem } from "@/modules/playground/lib/path-to-json";
...
const WebContainerPreview = ({ templateData, serverUrl, isLoading, error, instance, writeFileSync, forceResetup }: WebContainerPreviewProps) => {
